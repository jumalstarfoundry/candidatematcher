  ...
  prioritySite: {
    ...
    autoform: {
      ...
      options: function () {
          ...
          var selectArray = _.map(allCoursesDict, selectArrayCreationFunction);
    //      selectArray.push({label:"*Pending", value:"pending"});
    //      selectArray.push({label:"*Unassigned", value:"unassigned"});
